...
if __name__ == "__main__":
    feat1, feat2 = torch.rand((2, 128)), torch.rand((2, 128))
    ...
    assert fusion1.shape == (2, 256)
    assert fusion2.shape == (2, 256)